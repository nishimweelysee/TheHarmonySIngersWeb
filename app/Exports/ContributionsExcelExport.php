...
class ContributionsExcelExport implements FromCollection, WithHeadings, WithMapping, WithTitle, WithEvents
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Add subtitle
                $sheet->setCellValue('A2', 'Contributions Export Report');
