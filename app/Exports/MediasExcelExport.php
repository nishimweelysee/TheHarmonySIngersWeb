...
class MediasExcelExport implements FromCollection, WithHeadings, WithMapping, WithTitle, WithEvents
{
    protected $medias;
    ...
    public function map($media): array
    {
        return [
            ...
            $media->updated_at->format('Y-m-d H:i:s'),
        ];
    }

    public function title(): string
    {
        return 'Medias Export';
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Add subtitle
                $sheet->setCellValue('A2', 'Medias Export Report');
