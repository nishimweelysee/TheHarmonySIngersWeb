...
<div class="page-header enhanced-header campaign-edit-header">
    ...
    <div class="header-content">
        <div class="header-text">
            ...
            <div class="header-details">
                <h2 class="header-title">Edit Campaign: {{ $contributionCampaign->name }}</h2>
                <p class="header-subtitle">Update campaign information and settings</p>
                <div class="header-stats">
                    <div class="stat-item">
                        <span class="stat-number">
                            <i class="fas fa-edit"></i>
                        </span>
                        <span class="stat-label">Update Campaign</span>
                    </div>
                    <div class="stat-item">
                        <span class="stat-number">
                    ...
                    <div class="stat-item">
                        ...
                        <span class="stat-label">Save Changes</span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="content-card enhanced-card">
    ...
    <div class="card-content">
        <form method="POST" action="{{ route('admin.contribution-campaigns.update', $contributionCampaign) }}" class="campaign-form enhanced-form">
            @csrf
            @method('PUT')
                    ...
                    <div class="form-row">
                        <div class="form-group enhanced-group">
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                value="{{ old('name', $contributionCampaign->name) }}"
                        ...
                        <div class="form-group enhanced-group">
                            ...
                            <select id="type" name="type" class="form-select enhanced-select" required>
                                ...
                                <option value="monthly" {{ old('type', $contributionCampaign->type) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                <option value="project" {{ old('type', $contributionCampaign->type) == 'project' ? 'selected' : '' }}>Project</option>
                                <option value="event" {{ old('type', $contributionCampaign->type) == 'event' ? 'selected' : '' }}>Event</option>
                                <option value="special" {{ old('type', $contributionCampaign->type) == 'special' ? 'selected' : '' }}>Special</option>
                            </select>
                    ...
                    <div class="form-row">
                        <div class="form-group enhanced-group">
                            ...
                            <input type="date" id="start_date" name="start_date"
                                class="form-input enhanced-input"
                                value="{{ old('start_date', $contributionCampaign->start_date->format('Y-m-d')) }}" required>
                            <div class="input-glow"></div>
                            @error('start_date')
                            <span class="error-message enhanced-error">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group enhanced-group">
                            ...
                            <input type="date" id="end_date" name="end_date"
                                class="form-input enhanced-input"
                                value="{{ old('end_date', $contributionCampaign->end_date->format('Y-m-d')) }}" required>
                            <div class="input-glow"></div>
                            @error('end_date')
                            <span class="error-message enhanced-error">{{ $message }}</span>
                            @enderror
                ...
                <div class="form-section">
                        ...
                        <div class="form-group enhanced-group">
                            ...
                            <div class="input-group enhanced-input-group">
                                ...
                                <input type="number" id="target_amount" name="target_amount"
                                    class="form-input enhanced-input"
                                    value="{{ old('target_amount', $contributionCampaign->target_amount) }}"
                                    step="0.01" min="0"
                        ...
                        <div class="form-group enhanced-group">
                            ...
                            <div class="input-group enhanced-input-group">
                                ...
                                <input type="number" id="min_amount_per_person" name="min_amount_per_person"
                                    class="form-input enhanced-input"
                                    value="{{ old('min_amount_per_person', $contributionCampaign->min_amount_per_person) }}"
                                    step="0.01" min="0"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group enhanced-group">
                            ...
                            <select id="status" name="status" class="form-select enhanced-select" required>
                                ...
                                <option value="active" {{ old('status', $contributionCampaign->status) == 'active' ? 'selected' : '' }}>Active</option>
                                <option value="completed" {{ old('status', $contributionCampaign->status) == 'completed' ? 'selected' : '' }}>Completed</option>
                                <option value="cancelled" {{ old('status', $contributionCampaign->status) == 'cancelled' ? 'selected' : '' }}>Cancelled</option>
                            </select>
                            <div class="select-glow"></div>
                            @error('status')
                            <span class="error-message enhanced-error">{{ $message }}</span>
                    ...
                    <div class="form-group enhanced-group full-width">
                        ...
                        <select id="year_plan_id" name="year_plan_id" class="form-select enhanced-select">
                            ...
                            <option value="{{ $plan->id }}" {{ old('year_plan_id', $contributionCampaign->year_plan_id) == $plan->id ? 'selected' : '' }}>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group enhanced-group full-width">
                        ...
                        <textarea id="description" name="description"
                            ...
                            rows="4"
                            placeholder="Describe the purpose and goals of this campaign...">{{ old('description', $contributionCampaign->description) }}</textarea>
                    ...
                    <div class="form-group enhanced-group full-width">
                        ...
                        <textarea id="campaign_notes" name="campaign_notes"
                            class="form-textarea enhanced-textarea"
                            rows="4"
                            placeholder="Any additional notes or internal comments about this campaign...">{{ old('campaign_notes', $contributionCampaign->campaign_notes) }}</textarea>
                        <div class="textarea-glow"></div>
