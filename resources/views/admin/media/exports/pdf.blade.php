...
<head>
    ...
    <title>Media Export Report - The Harmony Singers</title>
    <style>
        body {
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $media->file_path ?? 'N/A' }}</td>
                    <td>{{ Str::limit($media->description ?? 'N/A', 50) }}</td>
                    <td>{{ $media->size ?? 'N/A' }}</td>
