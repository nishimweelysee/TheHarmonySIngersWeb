...
<head>
    ...
    * {
    ...
    .sidebar-logo:hover .sidebar-logo-svg {
        transform: scale(1.05);
    }
    ...
    .checkbox-group.enhanced-checkbox {
        display: flex;
        align-items: center;
        gap: var(--space-3);
        padding: var(--space-3);
    ...
    .checkbox-group.enhanced-checkbox:hover {
        background: var(--white);
        border-color: var(--primary);
        box-shadow: var(--shadow-md);
    }
    ...
    .enhanced-checkbox-input:checked+.checkbox-label .checkbox-custom {
        background: var(--primary);
        border-color: var(--primary);
    }

    .enhanced-checkbox-input:checked+.checkbox-label .checkbox-custom::after {
        content: '✓';
        position: absolute;
        top: 50%;
        left: 50%;
...
<body>
        ...
        <aside class="admin-sidebar" id="adminSidebar">
            <div class="sidebar-header">
                <div class="sidebar-logo">
                    <svg width="50" height="50" viewBox="0 0 120 120" class="sidebar-logo-svg">
                        <defs>
                        ...
                        <circle cx="60" cy="60" r="55" fill="url(#sidebarLogoGradient)" />
                    ...
                    <div class="sidebar-logo-text">
                        <div class="sidebar-logo-title">The Harmony Singers</div>
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="{{ route('admin.members.index') }}"
                        class="nav-item {{ request()->routeIs('admin.members.*') ? 'active' : '' }}" title="Members">
        ...
        <main class="admin-main">
            ...
            <header class="admin-header">
                <div class="header-left">
                    ...
                    <button class="floating-sidebar-toggle" id="floatingSidebarToggle" onclick="toggleSidebarCollapse()"
                        title="Toggle Sidebar">
                        <i class="fas fa-chevron-left" id="floatingSidebarToggleIcon"></i>
                    </button>
    ...
    function toggleSidebarCollapse() {
        ...
        const floatingToggleIcon = document.getElementById('floatingSidebarToggleIcon');
        ...
        // Update both icon rotations
        if (isCollapsed) {
            if (toggleIcon) toggleIcon.style.transform = 'rotate(180deg)';
            if (floatingToggleIcon) floatingToggleIcon.style.transform = 'rotate(180deg)';
        } else {
            if (toggleIcon) toggleIcon.style.transform = 'rotate(0deg)';
            if (floatingToggleIcon) floatingToggleIcon.style.transform = 'rotate(0deg)';
        }
    }
